        ...
        <tr style="padding:0;text-align:center;vertical-align:top;width:100%;" align="center">
            <td>                 
                ...
                <div style="float: left;width: 60%;">
                    <span style="padding:0 25px;color:#4a5773;font:400 16px Arial;margin-bottom:30px;"><?= Yii::t('app', 'You have successfully registered on the site {site}.', ['site' => Yii::$app->name]) ?></span>
                    <span style="padding:0 25px;color:#4a5773;font:400 16px Arial;margin-bottom:30px;"><?= Yii::t('app', 'We have created an account for you to more conveniently use our service.') ?></span>
                    <span style="padding:0 25px;color:#4a5773;font:400 16px Arial;margin-bottom:30px;"><?= Yii::t('app', 'Remember your login details:') ?></span>
                    ...
                    <div>
                        <span style="color: #4a5773;font:700 16px Arial;"><?= Yii::t('app', 'Password') ?>:</span>
